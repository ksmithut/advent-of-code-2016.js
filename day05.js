 ...
 * time by finding the [MD5](https://en.wikipedia.org/wiki/MD5) hash of some
 * Door ID (your puzzle input) and an increasing integer index (starting with
 * `0`).
 *
 ...
 * starts with five zeroes. If it does, the sixth character in the hash is the
 * next character of the password.
 *
 ...
 * slightly more <span title="This one says 'WOPR' in block
 * letters.">inspired</span> security mechanism. Clearly unimpressed by the
 * last version (in what movie is the password decrypted in order?!), the
 * Easter Bunny engineers have worked out [a better
