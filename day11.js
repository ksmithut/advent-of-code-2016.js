 ...
 *
 * The <span title="The previous version, model number PB-NUK, used
 * Blutonium.">experimental RTGs</span> have poor radiation containment, so
 * they're dangerously radioactive. The chips are prototypes and don't have
 * normal radiation shielding, but they do have the ability to generate an
 ...
 * the fourth floor for assembly. (Each elevator stop counts as one step, even
 * if nothing is added to or removed from it.)
 *
