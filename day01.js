 ...
 *
 * Santa's sleigh uses a <span title="An atomic clock is too inaccurate; he
 * might end up in a wall!">very high-precision clock</span> to guide its
 * movements, and the clock's oscillator is regulated by stars. Unfortunately,
 * the stars have been stolen... by the Easter Bunny. To save Christmas, Santa
 ...
 * turn left (`L`) or right (`R`) 90 degrees, then walk forward the given
