 ...
 *
 * In this <span title="*Please* don't try this at home.">modified code</span>,
 * the sender instead transmits what looks like random data, but for each
 * character, the character they actually want to send is slightly less likely
 * than the others. Even after signal-jamming noise, you can look at the letter
 * distributions in each column and choose the least common letter to
